...
public class Run {
    ...
    public static void main(String[] args) {
        ...
        seed = 12345;
        /*
         * Defines the features to characterize the knapsack instances (these are, at the moment, all the available features).
         */
         ...
         */
        problem.solve(testSet, heuristics);
        /*
         * Solves the test set by using the hyper-heuristic.
         */
        problem.solve(testSet, new HyperHeuristic[]{hyperHeuristic});
    }
